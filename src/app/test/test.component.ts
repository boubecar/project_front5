...
// Form Array //
  ...
  constructor(private router: Router, private fb: FormBuilder,private normeService: NormeServiceService, public CritereService: CritereService,public filialeService: FilialeService, public LocService: LocalService) {
  }
  //NormeList: any = []
  //CritereList: any = []
 ...
 // filList: any
  ...
  refreshcriList(e: any) {
    ...
    this.buildFormNotation(this.CritereList);
    console.log("dd")
  }
  refreshfilList() {
